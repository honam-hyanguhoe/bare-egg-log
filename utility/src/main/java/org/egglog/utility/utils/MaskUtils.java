...
public class MaskUtils {
     ...
     * @return
     */
    public String nameMaskKo(String name){
        String middleMask="";
     ...
     * @return
     */
    public String nameMaskEng(String name){
     ...
     * @return
     */
    public String hospitalMask(String hospital){
        StringBuilder maskedHospital=new StringBuilder();
        maskedHospital.append(hospital.charAt(0));
        maskedHospital.append("*".repeat(hospital.length()-1));
        return maskedHospital.toString();
    }
