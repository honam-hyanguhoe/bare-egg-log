...
public enum GroupErrorCode implements ErrorFormat {
    ...
    GROUP_ROLE_NOT_MATCH("권한이 없는 사용자의 요청입니다.", HttpStatus.UNAUTHORIZED),
    DUPLICATED_MEMBER("이미 존재하는 사용자입니다.", HttpStatus.BAD_REQUEST),
    UNKNOWN_ERROR("미등록 에러가 발생했습니다.",HttpStatus.INTERNAL_SERVER_ERROR),
    EXPIRED_INVITATION("만료된 초대입니다.",HttpStatus.UNAUTHORIZED),
    NOT_MATCH_INVITATION("올바르지 않은 초대입니다.",HttpStatus.UNAUTHORIZED),
